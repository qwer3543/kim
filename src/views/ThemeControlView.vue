        ...
        <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
          ...
          <div class="d-flex justify-content-between">
            ...
            <div class="form-check form-switch">
              <input class="form-check-input ms-0" id="mode-rtl" type="checkbox" data-theme-control="isRTL" :checked="true"/>
            </div>
          </div>
          <hr />
          <div class="d-flex justify-content-between">
            ...
            <div class="form-check form-switch">
              <input class="form-check-input ms-0" id="mode-fluid" type="checkbox" data-theme-control="isFluid" @click.prevent.stop="clickFulid" :checked="isFluidMode" v-model="isFluidMode"/>
            </div>
          </div>
          <hr />
...
<script setup>
    ...
    import {toggleFulid, clickFulid, isFluid} from '../utils/fluidUtil.js';

    const isFluidMode = computed(()=>{
        return isFluid();
    })

 //   const fluidBtn = ref(isFluid());
